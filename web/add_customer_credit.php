...
use App\Middlewares\AddCustomerCredit;
...
//set repository
$addCustomerCredit = new AddCustomerCredit($customerCreditRepository);
$customerCredit = $addCustomerCredit->createCustomerCredit($customerCredit);
